...
import net.mcreator.aaeitems.item.OutragedEngieShovelItem;
import net.mcreator.aaeitems.item.OutragedEngiePickaxeItem;
import net.mcreator.aaeitems.item.OutragedEngieItem;
import net.mcreator.aaeitems.item.OutragedEngieHoeItem;
import net.mcreator.aaeitems.item.OutragedEngieEssenceItem;
import net.mcreator.aaeitems.item.OutragedEngieAxeItem;
...
import net.mcreator.aaeitems.item.MassiveBanHammerPixelItem;
import net.mcreator.aaeitems.item.MassiveBanHammerItem;
import net.mcreator.aaeitems.item.LargeBanHammerPixelItem;
import net.mcreator.aaeitems.item.LargeBanHammerItem;
import net.mcreator.aaeitems.item.KickBanHammerPixelItem;
import net.mcreator.aaeitems.item.KickBanHammerItem;
import net.mcreator.aaeitems.item.HugeBanHammerPixelItem;
import net.mcreator.aaeitems.item.HugeBanHammerItem;
import net.mcreator.aaeitems.item.GiganticBanHammerPixelItem;
import net.mcreator.aaeitems.item.GiganticBanHammerItem;
...
import net.mcreator.aaeitems.item.EnormousBanHammerPixelItem;
import net.mcreator.aaeitems.item.EnormousBanHammerItem;
...
import net.mcreator.aaeitems.item.ComicallyMassiveBanHammerPixelItem;
import net.mcreator.aaeitems.item.ComicallyMassiveBanHammerItem;
import net.mcreator.aaeitems.item.CodeRedeemersItem;
import net.mcreator.aaeitems.item.CodeRedeemersHammerPixelItem;
import net.mcreator.aaeitems.item.CodeRedeemersHammerItem;
...
public class AaeItemsModItems {
	...
	public static final RegistryObject<Item> OUTRAGED_ENGIE_BLOCK = block(AaeItemsModBlocks.OUTRAGED_ENGIE_BLOCK, AaeItemsModTabs.TAB_AAE_ITEMS_ITEMS);
	...
	public static final RegistryObject<Item> ANGEL_HATTED_PRESENT = block(AaeItemsModBlocks.ANGEL_HATTED_PRESENT, AaeItemsModTabs.TAB_AAE_ITEMS_ITEMS);
	public static final RegistryObject<Item> OUTRAGED_ENGIE_HELMET = REGISTRY.register("outraged_engie_helmet", () -> new OutragedEngieItem.Helmet());
	public static final RegistryObject<Item> OUTRAGED_ENGIE_CHESTPLATE = REGISTRY.register("outraged_engie_chestplate", () -> new OutragedEngieItem.Chestplate());
	public static final RegistryObject<Item> OUTRAGED_ENGIE_LEGGINGS = REGISTRY.register("outraged_engie_leggings", () -> new OutragedEngieItem.Leggings());
	public static final RegistryObject<Item> OUTRAGED_ENGIE_BOOTS = REGISTRY.register("outraged_engie_boots", () -> new OutragedEngieItem.Boots());
