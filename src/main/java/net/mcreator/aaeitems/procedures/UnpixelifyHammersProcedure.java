...
public class UnpixelifyHammersProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (AaeItemsModVariables.WorldVariables.get(world).yeah == false) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.LARGE_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.LARGE_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.LARGE_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.HUGE_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.HUGE_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.HUGE_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.ENORMOUS_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.ENORMOUS_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.ENORMOUS_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.GIGANTIC_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.GIGANTIC_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.GIGANTIC_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.MASSIVE_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.MASSIVE_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.MASSIVE_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.COMICALLY_MASSIVE_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.COMICALLY_MASSIVE_BAN_HAMMER.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.COMICALLY_MASSIVE_BAN_HAMMER_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
