...
public class PixelifyHammersProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (AaeItemsModVariables.WorldVariables.get(world).yeah == true) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.BIGGER_BAN_HAMMER.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.BIGGER_BAN_HAMMER_PIXEL.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.BIGGER_BAN_HAMMER.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AaeItemsModItems.BIGGEST_BAN_HAMMER.get())) : false) {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AaeItemsModItems.BIGGEST_BAN_HAMMER_PIXEL.get());
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AaeItemsModItems.BIGGEST_BAN_HAMMER.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
