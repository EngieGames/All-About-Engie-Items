...
import net.mcreator.aaeitems.procedures.GUIRenderProcedure;
import net.mcreator.aaeitems.procedures.GUIRender2Procedure;
...
public class MetalChestUIScreen extends AbstractContainerScreen<MetalChestUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("aae_items:textures/screens/metal_chest_ui.png");
