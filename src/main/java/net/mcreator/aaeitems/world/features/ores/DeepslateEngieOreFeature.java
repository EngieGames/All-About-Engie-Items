...
public class DeepslateEngieOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("aae_items:deepslate_engie_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.DEEPSLATE.defaultBlockState()), AaeItemsModBlocks.DEEPSLATE_ENGIE_ORE.get().defaultBlockState())), 16));
